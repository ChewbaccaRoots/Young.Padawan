# Testes automatizados, para os ordenadores com dois algoritmos e situações diferentes
...
class TestaOrdenador:
    ...
    def testa_selacao_direta_aleat(self, o, l_aleat):
    ...
    def testa_selacao_direta_quase(self, o, l_quase):
